<?php
  ...
  $dashboard_filter_values['from_date'] = transaction_edition_filter_date_value(transaction_edition_filter_input('dashboard_filter_from_date', 'start_edition_date'));
  $dashboard_filter_values['to_date'] = transaction_edition_filter_date_value(transaction_edition_filter_input('dashboard_filter_to_date', 'end_edition_date'));
  ...
  if($dashboard_filter_values['from_date']!=''){
    $general_filtering_data .= " AND transaction_editions.insertion_date>=".transaction_edition_filter_sql_value($dashboard_filter_values['from_date'])." ";
  }
  if($dashboard_filter_values['to_date']!=''){
    $general_filtering_data .= " AND transaction_editions.insertion_date<=".transaction_edition_filter_sql_value($dashboard_filter_values['to_date'])." ";
  }
  if($dashboard_filter_values['from_date']!='' || $dashboard_filter_values['to_date']!=''){
    transaction_edition_add_filter_label('Edition Date', trim($dashboard_filter_values['from_date'].' - '.$dashboard_filter_values['to_date'], ' -'));
  }
                ...
                <form class="dashboard-filter-form" id="dashboard_transaction_edition_filter_form" role="form" action="report_transaction_edition.php" method="GET">
                  ...
                  <div class="dashboard-filter-grid">
                    ...
                    <div class="dashboard-filter-field dashboard-filter-field-half">
                      <label for="dashboard_filter_from_date">Edition date from</label>
                    ...
                    <div class="dashboard-filter-field dashboard-filter-field-half">
                      <label for="dashboard_filter_to_date">Edition date to</label>
                      <div class="dashboard-filter-input-icon">
                        <i class="far fa-calendar-alt"></i>
