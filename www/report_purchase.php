<?php
  ...
  $purchase_sq = $db->query("SELECT * FROM `purchases` WHERE deleted='0' $holu_filtering_data AND province IN ($accessed_provinces) AND logistic_cashes_id IN ($accessed_logistic_cashes) ORDER BY is_approved ASC, id DESC limit $holu_to OFFSET $holu_from");
                            ...
                            <td class="text-center">
                              <div class="dropdown mt-1 opertation_container">
                                ...
                                <div class="dropdown-content dropdown-menu-right operation_list">
                                  ...
                                  <?php
                                  if(check_access("system_accessibility/request/report_purchase/approve_purchase/")==1 AND $purchase_row['is_approved']==0){
                                  ?>
                                  <a class="dropdown-item" onclick="load_modal('<?php echo $_SERVER['PHP_SELF']; ?>', 'controller_purchase.php', 'approve_purchase_form', 'general_lg', '<?php echo holu_encode($purchase_row['id']); ?>');"><i class="fas fa-circle"></i> Approve Purchase</a>
                                  <?php
                                  }
                                  ?>
                                  ...
                                  <?php
                                  if(check_access("system_accessibility/request/report_purchase/view_attachment")){
                                  ?>
