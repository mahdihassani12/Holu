		...
		array(
			...
			"subs" => array(
				...
				array(
					...
					"label" => "Backups",
					"icon" => '',
					"location" => "list_backup/",
					"path" => "system_accessibility/management/list_backup/",
					"subs" => array(
						array(
							"type" => "operation",
							"url" => "",
							...
							"icon" => '',
							"location" => "download_backup/",
							"path" => "system_accessibility/management/list_backup/download_backup",
							"subs" => array(),
						),
						array(
							"type" => "operation",
							...
							"path" => "system_accessibility/management/list_backup/delete_backup",
							"subs" => array(),
						),
					),
				),
